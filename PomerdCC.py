...
print("
Bu yalnızca Visa kredi kartları üretir.")
nb_nitros = int(input("Lütfen oluşturulacak kart sayısını girin:
"))
nb = 1
print("Kredi kartı üretimi.")
while nb <= nb_nitros:
    ...
    f = open('PomerdVisaCC.txt', "a+")
    f.write(f'{card}\n')
    f.close()

    print(f"[Oluşturuldu] - {card}")
    time.sleep(0.025)
    nb += 1